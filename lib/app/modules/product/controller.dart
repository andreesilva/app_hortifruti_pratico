...
import 'package:app_hortifruti_pratico/app/widgets/quatity_and_weight/quantity_and_weight_controller.dart';
...
class ProductController extends GetxController {
  ...
  void addCart() async {
    var quantity = Get.find<QuatityAndWeightController>().quantity;

    if (_cartService.isANeswStore(store.value!)) {
