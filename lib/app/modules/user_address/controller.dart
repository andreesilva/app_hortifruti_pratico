...
class UserAddressController extends GetxController
  ...
  var streetController = TextEditingController(text: 'Souza de Lima');
  var numberController = TextEditingController(text: '345');
  var neighborhoodController = TextEditingController(text: 'Tamarineira');
  var referenceController = TextEditingController(text: 'Ao lado da Igreja');
